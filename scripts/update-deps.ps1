...
# Bump vendored BepInEx (win x64, v5.4.x) and rewrite vendor/bepinex/{LICENSE,README.md}.
# Manual: dev runs this when they want a fresh upstream bump, then commits the result.
...
Write-Host ""
Write-Host "vendor/bepinex refreshed (BepInEx win x64). Review and commit." -ForegroundColor Green
